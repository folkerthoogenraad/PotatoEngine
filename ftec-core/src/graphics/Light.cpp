...
namespace ftec {
	...
	mat4 Light::getShadowMatrix() const
	{
		//return mat4::scale(vec3(0.2f, 0.2f, -0.2f)) * mat4::rotationX(45) * mat4::rotationY(45);
		return  mat4::fromForward(m_Direction, vec3(0,1,0)) * mat4::scale(vec3(0.1f, 0.1f, -0.1f)); // TODO some shadow range calculations or something
	}
}
